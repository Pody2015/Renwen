<%@ Page Title="Tbl_Video" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="zs.Web.Tbl_Video.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="thumb" HeaderText="thumb" SortExpression="thumb" ItemStyle-HorizontalAlign="Center"  /> 
		...
		<asp:BoundField DataField="leiid" HeaderText="leiid" SortExpression="leiid" ItemStyle-HorizontalAlign="Center"  /> 
