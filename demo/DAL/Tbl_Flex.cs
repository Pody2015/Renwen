...
namespace zs.DAL
{
	...
	public partial class Tbl_Flex
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Tbl_Flex"); 
		}
		...
		public bool Exists(int id)
		{
			...
			strSql.Append("select count(1) from Tbl_Flex");
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into Tbl_Flex(");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@keyValue", SqlDbType.VarChar,150)};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update Tbl_Flex set ");
		...
		public bool Delete(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Tbl_Flex ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		public zs.Model.Tbl_Flex GetModel(int id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select  top 1 id,keyName,keyValue from Tbl_Flex ");
			strSql.Append(" where id=@id");
			SqlParameter[] parameters = {
					new SqlParameter("@id", SqlDbType.Int,4)
			};
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,keyName,keyValue ");
			strSql.Append(" FROM Tbl_Flex ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,keyName,keyValue ");
			strSql.Append(" FROM Tbl_Flex ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Tbl_Flex T ");
