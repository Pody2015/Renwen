...
namespace zs.DAL
{
	...
	public partial class Sys_RoleFunction
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("ID", "Sys_RoleFunction"); 
		}
		...
		public bool Exists(int ID)
		{
			...
			strSql.Append("select count(1) from Sys_RoleFunction");
		...
		public bool Delete(int ID)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from Sys_RoleFunction ");
			strSql.Append(" where ID=@ID");
			SqlParameter[] parameters = {
					new SqlParameter("@ID", SqlDbType.Int,4)
			};
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM Sys_RoleFunction ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" ID,RoleID,FunctionID ");
			strSql.Append(" FROM Sys_RoleFunction ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from Sys_RoleFunction T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "Sys_RoleFunction";
