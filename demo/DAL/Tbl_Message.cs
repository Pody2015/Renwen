...
namespace zs.DAL
{
	...
	public partial class Tbl_Message
	{
		...
		public int GetMaxId()
		{
		return DbHelperSQL.GetMaxID("id", "Tbl_Message"); 
		}
		...
		public int Add(zs.Model.Tbl_Message model)
		{
			...
			strSql.Append("name,mail,tel,conts,askTime,reply,replyTime,isShow)");
			...
			SqlParameter[] parameters = {
					...
					new SqlParameter("@conts", SqlDbType.VarChar,250),
					new SqlParameter("@askTime", SqlDbType.DateTime),
					new SqlParameter("@reply", SqlDbType.VarChar,250),
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,name,mail,tel,conts,askTime,reply,replyTime,isShow ");
		...
		public DataSet GetList(int Top,string strWhere,string filedOrder)
		{
			...
			strSql.Append(" id,name,mail,tel,conts,askTime,reply,replyTime,isShow ");
			strSql.Append(" FROM Tbl_Message ");
			if(strWhere.Trim()!="")
			{
				strSql.Append(" where "+strWhere);
