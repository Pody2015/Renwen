...
public class fileUp : IHttpHandler {
    ...
    public void ProcessRequest (HttpContext context) {
        ...
        string[] filetype = { ".rar", ".doc", ".docx", ".zip", ".pdf", ".txt", ".xls", ".xlsx", ".ppt",".pptx" };    //文件允许格式
        ...
        context.Response.Write("{'state':'" + state + "','url':'" + url.TrimStart('.').TrimStart('.').TrimStart('/') + "','title':'" + title + "','fileType':'" + currentType + "'}");
    }
