<%@ Page Language="C#" AutoEventWireup="true" CodeFile="test.aspx.cs" Inherits="admincp_test" %>
    ...
    <div id="container">
        ...
        <div id="header">
            ...
            <div id="top">
                <!-- Logo -->
                <div class="logo">
                    <a href="#" title="浙江树人大学招生网" class="tooltip">
                ...
                <div class="meta">
                    <p>
                        Welcome, Johnatan Doe!</p>
                    <ul>
                        <li><a href="#" title="End administrator session" class="tooltip"><span class="ui-icon ui-icon-power">
                        </span>安全退出</a></li>
                        <li><a href="#" title="Account Management" class="tooltip"><span class="ui-icon ui-icon-wrench">
                        </span>账户管理</a></li>
                        <li><a href="#" title="Change Your Password" class="tooltip"><span class="ui-icon ui-icon-person">
                        </span>密码修改</a></li>
                    </ul>
                </div>
            ...
            <div id="navbar">
                <ul class="nav">
                    <li><a href="./Default.aspx">管理首页</a></li>
        ...
        <div id="bgwrap">
            ...
            <div id="content">
                <div id="main">
                    <h1>
                        Welcome, <span>Johnatan</span>!</h1>
                    <p>
                        What would you like to do today?</p>
                    <div class="pad20">
                        <!-- Big buttons -->
                        <ul class="dash">
                            <li><a href="#" title="Write a new article" class="tooltip">
                                <img src="assets/icons/8_48x48.png" alt="" />
                                <span>New article</span> </a></li>
                            <li><a href="#" title="What your team posted" class="tooltip">
                                <img src="assets/icons/7_48x48.png" alt="" />
                                <span>Last articles</span> </a></li>
                            <li><a href="#" title="Manage users and accounts" class="tooltip">
                                <img src="assets/icons/16_48x48.png" alt="" />
                                <span>Users</span> </a></li>
                            <li><a href="#" title="Your site's statistics" class="tooltip">
                                <img src="assets/icons/4_48x48.png" alt="" />
                                <span>Statistics</span> </a></li>
                            <li><a href="#" title="Bandwidth and traffic" class="tooltip">
                                <img src="assets/icons/14_48x48.png" alt="" />
                                <span>Bandwidth</span> </a></li>
                            <li><a href="#" title="Server warnings" class="tooltip">
                                <img src="assets/icons/5_48x48.png" alt="" />
                                <span>Server warnings</span> </a></li>
                            <li><a href="#" title="Manage downloads" class="tooltip">
                                <img src="assets/icons/3_48x48.png" alt="" />
                                <span>Downloads</span> </a></li>
                            <li><a href="#" title="Lorem ipsum" class="tooltip">
                                <img src="assets/icons/9_48x48.png" alt="" />
                                <span>Listings</span> </a></li>
                            <li><a href="#" title="Users' photo gallery" class="tooltip">
                                <img src="assets/icons/1_48x48.png" alt="" />
                                <span>Gallery</span> </a></li>
                            <li><a href="#" title="0 new messages" class="tooltip">
                                <img src="assets/icons/25_48x48.png" alt="" />
                                <span>Inbox</span> </a></li>
                            <li><a href="#" title="Browse for files" class="tooltip">
                                <img src="assets/icons/21_48x48.png" alt="" />
                                <span>File browser</span> </a></li>
                            <li><a href="#" title="Calculator" class="tooltip">
                                <img src="assets/icons/30_48x48.png" alt="" />
                                <span>Calculator</span> </a></li>
                            <li><a href="#" title="RSS Feeds" class="tooltip">
                                <img src="assets/icons/29_48x48.png" alt="" />
                                <span>Feeds</span> </a></li>
                            <li><a href="#" title="Lorem ipsum" class="tooltip">
                                <img src="assets/icons/20_48x48.png" alt="" />
                                <span>Media</span> </a></li>
                            <li><a href="#" title="Lorem ipsum" class="tooltip">
                                <img src="assets/icons/26_48x48.png" alt="" />
                                <span>Latest comments</span> </a></li>
                        </ul>
                        <!-- End of Big buttons -->
                    </div>
                    <hr />
                    ...
                    <div class="pad20">
                        <p>
                            Wide Admin provides some nice graphics and effects for custom notification messages.
                            Clicking on one message will make it disappear! This is optional, of course!</p>
                        <div class="message success close">
                            <h2>
                                Congratulations!</h2>
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vulputate ligula
                                est, ut facilisis magna. Quisque vitae est sapien. Etiam in diam ipsum. Etiam condimentum
                                euismod eleifend. Lorem! Vestibulum quis turpis eu justo porta tincidunt.</p>
                        </div>
                        <div class="message warning close">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vulputate ligula
                                est, ut facilisis magna. Quisque vitae est sapien. Etiam in diam ipsum. Etiam condimentum
                                euismod eleifend. Vivamus gravida nunc in augue accumsan vitae pharetra tellus pretium.
                                Vestibulum non mauris in nunc dictum faucibus.</p>
                        </div>
                        <div class="message error close">
                            ...
                            <p>
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla vulputate ligula
                                est, ut facilisis magna. Quisque vitae est sapien. Etiam in diam ipsum. Etiam condimentum
                                euismod eleifend. Vestibulum quis turpis eu justo porta tincidunt.
                            </p>
                        </div>
                    ...
                    <hr />
                    <h1>
                        Three columns, sortable content</h1>
                    <div class="pad20">
                            ...
                            <div class="cols3 column">
                                <div class="portlet ui-widget ui-widget-content ui-helper-clearfix ui-corner-all">
                                    ...
                                    <div class="portlet-content">
                                        ...
                                        <p>
                                            Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam eu orci quam, vitae
                                            molestie nulla. Etiam tempus suscipit imperdiet. Nam vitae purus neque, nec placerat
                                            dui. Aenean tristique sapien metus. Mauris tempus arcu vel sapien tristique vitae
                                            sagittis nisi hendrerit.</p>
                                    </div>
                                </div>
                            </div>
                            <!-- End of Column one -->
                    ...
                    <hr />
                    <h1>
                        Tabs (Forms, Tables, Icons and Buttons)</h1>
                    <div class="pad20">
                        <!-- Tabs -->
                        <div id="tabs">
                            <ul>
                            ...
                            <div id="tabs-1">
                                ...
                                <!-- End of Form -->
                                <p>
                                    Proin vel ullamcorper purus. Pellentesque accumsan magna volutpat lacus volutpat
                                    quis lacinia metus vehicula. In hac habitasse platea dictumst. Aenean lorem mauris,
                                    iaculis sit amet condimentum luctus, volutpat ac nunc. Pellentesque cursus, eros
                                    ac lobortis dignissim, diam tortor malesuada lorem, cursus tempus dui sapien hendrerit
                                    mi. Nulla facilisi. Nulla facilisi. Fusce tincidunt dui sed eros interdum vel dignissim
                                    enim tempus. Vestibulum massa ipsum, volutpat eget blandit ac, semper eu dui. Nam
                                    eget mi sapien.
                                </p>
                            </div>
                            <!-- End of First tab -->
                            ...
                            <div id="tabs-2">
                                <p>
                                    A simple full width table</p>
                                <p>
                                    Cras adipiscing, nisl ut rutrum vulputate, risus eros tincidunt justo, pellentesque
                                    dapibus elit massa vel risus. Nulla ac leo in ipsum sodales malesuada. Cras sit
                                    amet est nisl, at tristique augue. Class aptent taciti sociosqu ad litora torquent
                                ...
                                <p>
                                    This is a normal table, content defines its width.</p>
                            ...
                            <div id="tabs-3">
                                ...
                                <p>
                                    This icons can be used for buttons, header buttons, etc.</p>
                                <p>
                                    Buttons made with these icons:
                                </p>
                                <p>
                                    <a href="#" class="button tooltip" title="This is a random button"><span class="ui-icon ui-icon-trash">
                                    </span>Remove</a><a href="#" class="button"><span class="ui-icon ui-icon-radio-off"></span>Radio
                                        off</a><a href="#" class="button"><span class="ui-icon ui-icon-play"></span>Play</a></p>
                            </div>
                            <!-- End of Third tab -->
                        </div>
                        <!-- End of Tabs -->
                    ...
                    <hr />
                    <h1>
                        Sliders, Progressbar, Dialogs!</h1>
                    <div class="pad20">
                        <p>
                            <a href="#" class="button tooltip" title="Click me to open the dialog!" id="dialog_link">
                                <span class="ui-icon ui-icon-newwin"></span>Open Dialog</a></p>
                        <!-- Dialog -->
                        <div id="dialog" title="Welcome message!">
                            <p>
                                Welcome to <b>Wide Admin</b>!</p>
                            <p>
                                Wide Admin is one powerful customizable backend user interface. Check the demo to
                                see what it can do!</p>
                            <p>
                                And this is a custom message text that you can modify to fit your needs.</p>
                        </div>
                        <!-- End of Dialog -->
            ...
            <div id="sidebar">
                ...
                <div id="accordion">
                    <div>
                        <h3>
                            <a href="#" title="First slide" class="tooltip">First</a></h3>
                        <div>
                            Praesent augue urna, vehicula sed sollicitudin quis, dignissim nec est. Quisque
                            dignissim lorem at metus vehicula ut feugiat eros vestibulum. Suspendisse ultrices,
                            massa luctus aliquam faucibus, sem quam fermentum nisl, non posuere quam nunc vel
                            tellus.</div>
                    </div>
                    <div>
                        <h3>
                            <a href="#" title="Second slide" class="tooltip">Second</a></h3>
                        <div>
                            Sed sem elit, porttitor quis vestibulum ut, euismod id purus. Praesent vulputate
                            dolor vel nisi mattis sollicitudin. Curabitur placerat quam at sem tempor ac sodales
                            nunc dapibus. Nullam mi purus, adipiscing in facilisis sed, posuere ut ipsum.</div>
                    </div>
                    <div>
                        <h3>
                            <a href="#" title="Third slide" class="tooltip">Third</a></h3>
                        <div>
                            Praesent augue urna, vehicula sed sollicitudin quis, dignissim nec est. Quisque
                            dignissim lorem at metus vehicula ut feugiat eros vestibulum. Suspendisse ultrices,
                            massa luctus aliquam faucibus, sem quam fermentum nisl, non posuere quam nunc vel
                ...
                <div class="sort">
                    <div class="box ui-widget ui-widget-content ui-corner-all portlet">
                        ...
                        <div class="portlet-content">
                            <p>
                                This is a sortable dialog. Praesent augue urna, vehicula sed sollicitudin quis,
                                dignissim nec est.</p>
                        </div>
                    </div>
                    <div class="box ui-widget ui-widget-content ui-corner-all portlet">
