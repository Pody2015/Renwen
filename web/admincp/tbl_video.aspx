<%@ Page Title="" Language="C#" MasterPageFile="~/admincp/MasterAdmin.master" AutoEventWireup="true" CodeFile="tbl_video.aspx.cs" Inherits="admincp_tbl_video" %>
 ...
 <script src="./js/artDialog.js?skin=black" type="text/javascript"></script>
    <script>
        function tan(num) {
            ...
            art.dialog.list['EF893L'].content('<iframe height=510 width=930 frameborder=no border=0 src=./tbl_videoadd.aspx?id=' + num + '></iframe>');
        }
...
<div id="content">
        <div id="main">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        &nbsp;./video.aspx?id=<%# ApplicationMethod.encript(Eval("id").ToString()) %></td>
                    <td>
        ...
        跳转到<asp:Literal ID="Literal1" runat="server"></asp:Literal>页
            ...
            <input id="Button2" type="button" value="添加视频" class="button" 
