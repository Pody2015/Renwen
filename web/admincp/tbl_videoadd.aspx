<%@ Page Language="C#" validateRequest="false" AutoEventWireup="true" CodeFile="tbl_videoadd.aspx.cs" Inherits="admincp_tbl_videoadd" %>
...
<body>
    ...
    <p><label>缩略图：</label>
        <asp:FileUpload ID="fu_thumb" runat="server" />
    </p>
    <p><label>视频swf地址：</label>
    <asp:TextBox ID="tb_videourl" runat="server"></asp:TextBox></p>
    <p><label>分类：</label>
