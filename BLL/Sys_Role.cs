...
namespace zs.BLL
{
	...
	{
		private readonly zs.DAL.Sys_Role dal=new zs.DAL.Sys_Role();
		public Sys_Role()
		{}
		#region  Method
		...
		/// 得到一个对象实体，从缓存中
		/// </summary>
		public zs.Model.Sys_Role GetModelByCache(int ID)
		{
			...
			return (zs.Model.Sys_Role)objModel;
		}
		...
		/// 获得数据列表
		/// </summary>
		public List<zs.Model.Sys_Role> GetModelList(string strWhere)
		{
		...
		/// 获得数据列表
		/// </summary>
		public List<zs.Model.Sys_Role> DataTableToList(DataTable dt)
		{
			List<zs.Model.Sys_Role> modelList = new List<zs.Model.Sys_Role>();
			int rowsCount = dt.Rows.Count;
			if (rowsCount > 0)
			{
				zs.Model.Sys_Role model;
				for (int n = 0; n < rowsCount; n++)
				{
					model = new zs.Model.Sys_Role();
